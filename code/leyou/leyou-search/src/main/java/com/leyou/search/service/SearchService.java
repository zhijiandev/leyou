...
public class SearchService {
    ...
    public SearchResult search(SearchRequest request) {
        ...
        //添加分类和品牌的聚合
        String categoryAddName = "categories"; //老师打错了
        String brandAggName = "brands";
        queryBuilder.addAggregation(AggregationBuilders.terms(categoryAddName).field("cid3"));
        ...
        //获取聚合结果集并解析
        List<Map<String, Object>> categories = gercategoryAggResult(goodsPage.getAggregation(categoryAddName));
    ...
    * 解析分类的聚合结果集
    * */
    private List<Map<String, Object>> gercategoryAggResult(Aggregation aggregation) {
        LongTerms terms = (LongTerms)aggregation;
